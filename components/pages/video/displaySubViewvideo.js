  ...
  return (
    <>
      {videoTracks.filter(v => v.getTracks()[0].kind === 'video').map(videoTrack => {
        return (
          <div className="relative mx-auto w-full" key={videoTrack.id}>
                ...
                <div className="flex justify-center relative rounded-lg overflow-hidden h-52">
                  <div className="transition-transform duration-500 transform ease-in-out hover:scale-110 w-full">
                    <div className="absolute inset-0 bg-black">
                      <VideoPlayer cssClass="w-full h-full object-cover" srcObject={videoTrack} />
                    </div>
                  </div>
                  ...
                  <div className="bg-gray-100 py-2 px-4 rounded-lg mt-2">
                    <div className="grid grid-cols-2 gap-4 leading-8">
                      <p className="inline-flex flex-col xl:flex-row xl:items-center text-gray-800">
                        ...
                        <span className="mt-2 xl:mt-0 text-amber-400">[Browser]</span>
                      </p>
                      <p className="inline-flex flex-col xl:flex-row xl:items-center text-gray-800">
                        <svg className="inline-block w-5 h-5 xl:w-4 xl:h-4 mr-3 fill-current text-gray-800"
                        ...
                        <span className="mt-2 xl:mt-0 text-amber-400">[OS]</span>
                      </p>
                    </div>
                    ...
                    <div className="">
                      ...
                      <p className="inline-flex flex-col xl:flex-row xl:items-center text-gray-800">
                        ...
                        <span className="mt-2 xl:mt-0"><span className="mt-2 xl:mt-0 text-amber-400">[subscriber audio track ID]</span></span>
                      </p>
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-2 mt-2 px-2">
                  ...
                  <div className="flex justify-end">
                    <p className="inline-block font-semibold text-primary whitespace-nowrap leading-tight rounded-xl">
                      <span className="text-gray-800 line-clamp-1 text-amber-400">[join time]</span>
                    </p>
                  </div>
                </div>
              </div>
